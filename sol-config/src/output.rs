...
use knuffel::Decode;
use sol_ipc::{ConfiguredMode, HSyncPolarity, Transform, VSyncPolarity};
...
pub struct Modeline {
    ...
    pub hsync_polarity: sol_ipc::HSyncPolarity,
    /// Vertical sync polarity: "+vsync" or "-vsync".
    pub vsync_polarity: sol_ipc::VSyncPolarity,
}
...
impl OutputName {
    pub fn from_ipc_output(output: &sol_ipc::Output) -> Self {
        Self {
