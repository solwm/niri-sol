...
use sol::layout::Options;
use sol::render_helpers::xray::XrayPos;
use sol::render_helpers::{RenderCtx, RenderTarget};
use sol_config::Color;
...
pub struct Tile {
    window: TestWindow,
    tile: sol::layout::tile::Tile<TestWindow>,
}
...
impl Tile {
    ...
    pub fn with_window(args: Args, window: TestWindow) -> Self {
        ...
        let mut tile = sol::layout::tile::Tile::new(
            window.clone(),
            size.to_f64(),
            1.,
            clock,
